...
class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.ViewHolder>  {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        void bindTo(Sport currentSport){
            ...
            //msportsImage.setImageBitmap(currentSport.getImageResource());

        }

        @Override
        public void onClick(View v) {
            Sport spitem = mSportsData.get(getAdapterPosition());
            Intent detailintent = new Intent(mContext,DetailActivity.class);
            detailintent.putExtra("title",spitem.getTitle());
            detailintent.putExtra("imageres",spitem.getImageResource());
